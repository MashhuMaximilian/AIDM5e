...
def build_transcript_capture_prompt(
    ...
    prompt = (
        ...
        "- IMPORTANT: the first audible second in this file is 0\n"
        "- IMPORTANT: every offset_seconds value must stay between 0 and expected_duration_seconds\n"
        "- IMPORTANT: never use session_start_offset_seconds as the segment timestamp\n"
